...
import com.gabrielbarth.contacts.ui.contact.form.ContactFormScreen
...
private object Routes {
    ...
    const val CONTACT_FORM =
        "${Screens.CONTACT_FORM}?${Arguments.CONTACT_ID}={${Arguments.CONTACT_ID}}"
}
